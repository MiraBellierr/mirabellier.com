        ...
        <div className="flex lg:flex-row flex-col flex-grow p-4 max-w-7xl mx-auto w-full">
            ...
            <div className="w-full max-w-md backdrop-blur-sm card-border rounded-2xl p-6 shadow-lg">
              <div className="text-center">
                ...
                <p className="text-sm text-blue-500">
                  Login with Discord to access your cute profile
                </p>
              </div>
          ...
          <aside className="w-full lg:w-1/5 mb-auto bg-blue-50 border border-blue-200 rounded-xl shadow-sm p-4 hidden lg:block">
            ...
            <ul className="text-sm text-blue-600 space-y-2">
              ...
              <li>
                • Your Discord avatar will be used as your profile picture
              </li>
              <li>
                • To change settings go to <strong>Settings</strong> after login
              </li>
              <li>• Safe and secure OAuth authentication</li>
            </ul>
            <div className="mt-4 text-xs text-blue-400 text-center">
              Be kind — this site is cute 💖
            </div>
          </aside>
        </div>
      </div>
