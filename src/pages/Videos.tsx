...
const Videos = () => {
            ...
            data.forEach((v: any) => {
              if (Array.isArray(v.likes)) {
                initial[v.id] = {
                  ...
                  liked: user ? v.likes.includes(user.id) : false,
                };
  ...
  useEffect(() => {
    if (searchQuery.trim() === "") {
      ...
      !isNaN(Number(debouncedSearchQuery)) &&
      parseInt(debouncedSearchQuery) <= videos.length
    ) {
  ...
  const handleTryPlaying = async () => {
    ...
    try {
      ...
      setVideoError(
        "Still unable to play video. Please try refreshing the page.",
      );
      setVideoLoading(false);
    }
  };
  ...
  const handleWheel = (e: React.WheelEvent) => {
    ...
    const atBottom =
      currentVideoIndex === Math.max(0, filteredVideos.length - 1);
    if (e.deltaY < 0 && atTop) {
      return;
    }
  ...
  return (
    <div className="lg:h-screen text-blue-900 font-[sans-serif] flex flex-col overflow-hidden">
      ...
      <div
        className="lg:flex-1 flex flex-col bg-cover bg-no-repeat"
        ...
        <div className="flex lg:flex-row flex-col flex-1 p-2 max-w-full mx-auto w-full lg:overflow-hidden">
          ...
          <div className="flex-grow flex-col">
            ...
            <div className="mt-4 p-4 border border-blue-300 rounded-lg bg-blue-100 shadow-md">
              <h2 className="font-bold text-blue-500 text-lg pb-2">
                search video here
              </h2>
            ...
            <div className="flex flex-col justify-center items-center p-4">
              {loading ? (
                ...
                <div className="text-red-500">
                  No videos found matching "{searchQuery}". Try a different
                  search.
                </div>
              ) : null}
                    ...
                    <div className="relative bg-black/50 p-4 rounded-xl overflow-hidden">
                      ...
                      <div className="absolute right-4 bottom-8 flex flex-col items-center space-y-4">
                        <Link
                          to={
                            currentVideo.userId
                              ? `/profile/${userCache[currentVideo.userId]?.username || currentVideo.author}`
                              : "#"
                          }
                          className="block"
                        >
                        ...
                        <button
                          onClick={() => setShowCommentsFor(currentVideo.id)}
                          className="flex flex-col items-center text-white"
                        >
              ...
              {showCommentsFor ? (
                <div className="w-full bg-gradient-to-br from-pink-50 to-yellow-50 border border-pink-100 rounded-2xl shadow-lg max-h-[70vh] flex flex-col overflow-hidden">
                  ...
                  <div className="p-4 flex-grow overflow-auto">
                    {!commentsMap[showCommentsFor] ||
                    commentsMap[showCommentsFor].length === 0 ? (
                  ...
                  <div className="p-4 border-t bg-transparent flex flex-col space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        placeholder={
                          replyTo ? "Replying..." : "Write a cute comment..."
                        }
                      />
                      <button
                        onClick={() => {
                ...
                <>
                  ...
                  <aside className="w-full lg:w-[200px] mb-auto bg-blue-100 border border-blue-300 rounded-xl shadow-md p-4 space-y-2">
                    ...
                    <div className="space-y-2 text-sm text-center font-bold border-t border-blue-800">
                      ...
                      <p className="text-blue-500 p-2">
                        If the video is not loading, try{" "}
                        <span className="font-extrabold underline">
                          refreshing the page
                        </span>
                        .
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md mx-4 animate-in fade-in zoom-in duration-300">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                This section contains videos that may not be suitable for
                younger audiences.
              </p>
              ...
              <div className="flex gap-4 mt-6">
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-pink-500 to-purple-500 text-white font-bold py-3 px-6 rounded-xl hover:from-pink-600 hover:to-purple-600 transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  Yes, I'm 16+
                </button>
                <button
                  ...
                  className="flex-1 bg-gray-200 text-gray-700 font-bold py-3 px-6 rounded-xl hover:bg-gray-300 transition-all shadow-md hover:shadow-lg"
                >
                  No, Go Back
                </button>
              </div>
              <p className="text-xs text-gray-500 mt-4">
                By clicking "Yes", you confirm that you are at least 16 years
                old.
              </p>
            </div>
          </div>
