        ...
        <div className="flex lg:flex-row flex-col flex-grow p-4 max-w-7xl mx-auto w-full">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-500">
                    Change your avatar, username, and profile info
                  </p>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="mt-4 space-y-4">
                ...
                <div>
                  ...
                  {bannerPreview && (
                    <div className="mt-2 h-24 rounded-lg overflow-hidden border border-blue-200">
                      <img
                        src={resolveAsset(bannerPreview) || undefined}
                        alt="banner preview"
                        className="w-full h-full object-cover"
                      />
                    </div>
                ...
                <div className="flex items-center justify-between">
                  <button
                    type="submit"
                    disabled={isSaving}
                    className="inline-flex items-center gap-2 bg-pink-500 text-white px-4 py-2 rounded-full shadow-sm hover:scale-105 transform transition"
                  >
          ...
          <aside className="right-side-panel w-full lg:w-1/5 mb-auto bg-blue-50 border border-blue-200 rounded-xl shadow-sm p-4 hidden lg:block">
            ...
            <ul className="text-sm text-blue-600 space-y-2">
              ...
              <li>
                • Your username must be unique; changing to an existing username
                will fail.
              </li>
              <li>• Password changes apply immediately — keep it safe.</li>
              <li>
                • Posts you create will show your current username and avatar.
              </li>
            </ul>
            <div className="mt-4 text-xs text-blue-400 text-center">
              Be kind — share smiles 💖
            </div>
          </aside>
        </div>
      </div>
