...
const Pics = () => {
  ...
  useEffect(() => {
    // Update canonical URL to point to the Pics page
                        ...
                        {currentPic.userId && (
                          <div className="absolute left-4 top-4 flex flex-col items-start space-y-1">
                            <div className="flex items-center gap-2">
                              <Link
                                to={`/profile/${userCache[currentPic.userId]?.username || currentPic.author}`}
                                className="block"
                              >
                                <img
                                  src={resolveAsset(
                                    userCache[currentPic.userId]?.avatar ||
                                      currentPic.authorAvatar ||
                              ...
                              >
                                {userCache[currentPic.userId]?.username ||
                                  currentPic.author ||
                                  "Unknown"}
                              </Link>
