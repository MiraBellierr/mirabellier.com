...
const AdminAnime = () => {
  ...
  if (!auth?.user)
    return <div className="p-6">Please login to access this page.</div>;
  if ((auth.user as any).discordId !== "548050617889980426")
          ...
          <main className="w-full lg:w-3/5 space-y-2 p-4">
            <div className="space-y-1 p-2 card-border bg-white/80 rounded-lg">
              ...
              <p className="text-sm text-blue-500">
                Add or remove entries from the anime sidebar. Changes persist to
                the server.
              </p>
              ...
              <div className="mt-4 space-y-3">
                <input
                  ...
                  className="w-full p-3 border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200"
                />
                <input
                ...
                <div className="flex gap-3">
                  <button
                    onClick={add}
                    className="px-4 py-2 bg-pink-500 text-white rounded-full shadow"
                  >
                    Add
                  </button>
                  <button
                    ...
                    className="px-4 py-2 border border-blue-200 rounded-full bg-white"
                  >
                    Clear
                  </button>
                  <button
